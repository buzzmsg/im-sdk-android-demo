...
import com.im.sdk.constant.MessageContentType.ContentType_Unknown
import com.im.sdk.constant.MessageStatus
import com.im.sdk.core.net.exception.TmException
import com.im.sdk.core.net.exception.TmmError
import com.im.sdk.core.net.toEntity
import com.im.sdk.message.content.*
...
//    }
    ...
    fun convertToTmMessage(messageEntity: MessageModel?): TmMessage {
        ...
        message.status =
            com.im.sdk.constant.MessageStatus.status(messageEntity?.status ?: MessageStatus.Sent.value())
