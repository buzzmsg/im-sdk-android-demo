package com.im.sdk.ui.view.message.adapter
...
import com.im.sdk.ui.view.link.textview.MessageTextLinkView
import com.im.sdk.ui.view.message.diff.MessageDiff
...
class MessageAdapter() : BaseMultiItemAdapter<TmmMessageVo>() {
    ...
    init {
        addItemType(
            com.im.sdk.constant.MessageContentType.ContentType_Text,
...
//                                WebViewActivity.starter(context, url ?: "", shareVisible = false)
        ...
        addItemType(
            0 - com.im.sdk.constant.MessageContentType.ContentType_Text,
