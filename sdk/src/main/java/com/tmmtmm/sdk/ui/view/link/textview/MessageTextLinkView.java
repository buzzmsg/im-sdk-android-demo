package com.tmmtmm.sdk.ui.view.link.textview;
...
import com.tmmtmm.sdk.ui.view.link.alpha.QMUIAlphaTextView;
import com.tmmtmm.sdk.ui.view.link.span.QMUIOnSpanClickListener;
import com.tmmtmm.sdk.ui.view.link.util.QMUILinkTouchMovementMethod;
import com.tmmtmm.sdk.ui.view.link.util.QMUILinkify;
 ...
 * @description
 */
public class MessageTextLinkView extends QMUIAlphaTextView implements QMUIOnSpanClickListener {
...
public static int AUTO_LINK_MASK_REQUIRED = QMUILinkify.WEB_URLS;
...
//        AUTO_LINK_SCHEME_INTERRUPTED.add("mailto");
    ...
    public MessageTextLinkView(Context context) {
        this(context, null);
        mLinkBgColor = null;
        mLinkTextColor = ContextCompat.getColorStateList(context, R.color.text_00C6DB);
    }

    public MessageTextLinkView(Context context, ColorStateList linkTextColor, ColorStateList linkBgColor) {
        this(context, null);
        mLinkBgColor = linkBgColor;
        mLinkTextColor = linkTextColor;
    }

    public MessageTextLinkView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setLinkBackgroundColor(ColorStateList linkBackgroundColor) {
        mLinkBgColor = linkBackgroundColor;
    }
