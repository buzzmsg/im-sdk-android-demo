...
object SpUtils {
    ...
    fun putStringSet(key: String, value: Set<String>) {
        MMKV.mmkvWithID(LoginCache.getAKey(), MMKV.SINGLE_PROCESS_MODE)
            .encode(key, value)
    }
    ...
    fun putString(id: String, key: String, value: String) {
        MMKV.mmkvWithID(LoginCache.getAKey(), MMKV.MULTI_PROCESS_MODE)
            .encode(key, value)
    }
    ...
    fun getString(key: String): String {
        return MMKV.mmkvWithID(LoginCache.getAKey(), MMKV.SINGLE_PROCESS_MODE)
            .decodeString(key, "")
    }
